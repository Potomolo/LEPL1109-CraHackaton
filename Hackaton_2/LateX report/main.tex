...
Adding more features does not significantly improve the results for either linear regression or logistic regression.
...
\begin{center}
    \includegraphics[width=15cm]{VISUALIZATION_CHART.png}
\end{center}
% ------------------------------------------------------------
\end{answer}
\pagebreak
